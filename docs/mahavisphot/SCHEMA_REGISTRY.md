...
- Database tables: 75
- Schema entities: 28
- Runtime export schema: `mahavisphot.export.v1` implemented in `editor/export-schema.js`
- Runtime media schema: `mahavisphot.media.v1` implemented in `editor/media-pipeline.js`
- Runtime media evidence schema: `mahavisphot.media.evidence.v1` generated by `scripts/mahavisphot-media-pipeline.mjs`
- Runtime renderer schema: `mahavisphot.renderer.v1` implemented in `editor/renderer-core.js`
- Runtime renderer evidence schema: `mahavisphot.renderer.evidence.v1` generated by `scripts/mahavisphot-renderer-parity.mjs`
